...
import { Plus, Trash2, PlaySquare, GraduationCap, Trophy } from "lucide-react";
...
export default function BlogsAdmin() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!error) {
      setShowForm(false);
      setFormData({ title: "", slug: "", excerpt: "", content: "", author_name: "", image_url: "", category: "Success Stories" });
      fetchBlogs();
    } else {
      ...
      {showForm && (
        <div className="bg-white p-6 rounded-xl shadow-sm mb-8 border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition">Publish Content</button>
          </form>
        </div>
      )}
